...
<!--         Praegune profiil:
        ...
        <form method="post" id="usrform" enctype="multipart/form-data">
            ...
            <br>
            <textarea required rows="4" cols="50" name="description" form="usrform"></textarea>
            <br>
            <label>Pilt</label>
            <br>
        ...
        <?php
            ...
            if (isset($_POST['upload'])) {
                ...
                $sql = 'UPDATE 185399_users SET description = "'.$description.'", photo = "'.$target.'" WHERE email = "'.$_SESSION['login_user'].'"';
